...
def gnss_ins_sim_publisher():
    ...
    # parse params:
    motion_def_name = rospy.get_param('motion_file')
    sample_freq_imu = rospy.get_param('sample_frequency/imu')
    sample_freq_gps = rospy.get_param('sample_frequency/gps')
    topic_name_imu = rospy.get_param('topic_name')
